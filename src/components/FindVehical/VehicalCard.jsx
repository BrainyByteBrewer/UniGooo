...
import carImage from "../../assets/bg1.png"; // Make sure this path is correct
...
const VehicalCard = ({
  ...
  return (
    <div
      onClick={onClick}
      className="bg-white rounded-lg shadow-md p-4 cursor-pointer hover:shadow-lg transition-shadow relative" // Added relative for absolute positioning of ribbon
    >
